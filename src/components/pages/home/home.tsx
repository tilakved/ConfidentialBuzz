    ...
    return (
        <>
            <aside className="flex">
                <div
                    className="flex flex-col items-center w-16 h-screen bg-white dark:bg-gray-900 dark:border-gray-700">
                    <div
                        className="flex flex-col items-center w-16 h-screen pt-8 bg-white space-y-8 dark:bg-gray-900 dark:border-gray-700">
                        <a>
                    ...
                    <div className="pb-4">
                        <a className="inline-block p-1.5 text-gray-500 focus:outline-nones transition-colors duration-200 rounded-lg dark:text-gray-400 dark:hover:bg-gray-800 hover:bg-gray-100 cursor-pointer"
                           onClick={() => LogOut()}>
                            <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M15 12L6 12M6 12L8 14M6 12L8 10" stroke="currentColor" stroke-width="1.5"
